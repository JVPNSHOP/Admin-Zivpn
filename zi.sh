...
# =======================
# FIXED server.py (panel မကြီး crash, GB Used/Left လှုပ်အောင်)
# =======================
...
def user_to_dict(row):
    # datetime parse error ဖြစ်ရင် panel မကြီးပျက်မသွားအောင် try/except
    try:
...
def enforce_quota_once():
    ...
    for r in rows:
        ...
        if raw_bytes is None:
            ...
            # iptables counter reset → အဟောင်းပေါင်း
