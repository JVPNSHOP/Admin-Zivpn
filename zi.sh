...
<head>
  ...
  <style>
    ...
    .footer-icons .tg { border-color:#38bdf8; }
    .footer-icons .fb { border-color:#3b82f6; }
    .footer-icons .ms { border-color:#22c55e; }
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="footer-icons">
        <span>Contact :</span>
        <a class="tg" href="#" target="_blank">📨 Telegram</a>
        <a class="fb" href="#" target="_blank">📘 Facebook</a>
        <a class="ms" href="#" target="_blank">💬 Messenger</a>
      </div>
    </div>
  </div>
