...
# show password while typing (no -s)
...
# NOTE: Real-time connection info from ZIVPN is not documented.
# For now, "Online" means "not expired yet", "Offline" means "expired".
# If ZIVPN later provides stats/logs with active sessions, this function can be
# extended to read those and override status.
...
<body>
  <div class="card">
    ...
    <form method="post">
      ...
      <!-- show password as plain text so mobile browsers like Termius show characters -->
    ...
    <div class="card">
      ...
      <div class="top-row">
        <div class="vps-box">
          ...
          <div class="muted" style="margin-top:4px;font-size:0.75rem;color:#9ca3af;">
