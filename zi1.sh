...
<head>
  ...
  <style>
    ...
    .tg .logo-circle { background:#2AABEE; }      /* Telegram style */
    .fb .logo-circle { background:#1877F2; }      /* Facebook style */
    .ms .logo-circle { background:#0084FF; }      /* Messenger style */
